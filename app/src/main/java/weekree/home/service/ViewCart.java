...
public class ViewCart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uid=new MyDb(ViewCart.this).getUserID().trim();;
        ...
        webmenu.loadUrl(BaseUrl.HOSTNAME + "ViewCart.php?uid=" + uid);
        Toast.makeText(ViewCart.this, "Id id " + uid, Toast.LENGTH_LONG).show();
        webmenu.setWebChromeClient(new WebChromeClient() {
    ...
    public void placeorder(View  v)
    {
        try{
            ...
            Intent intent=new Intent(ViewCart.this,OrderPlace.class);
