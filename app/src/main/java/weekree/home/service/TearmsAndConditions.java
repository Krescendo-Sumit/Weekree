...
public class TearmsAndConditions extends AppCompatActivity {
    WebView webmenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tearms_and_conditions);
        uid = new MyDb(TearmsAndConditions.this).getUserID().trim();
        ...
        webmenu.loadUrl(BaseUrl.HOSTNAME + "TermsAndConditions.php?uid="+uid);
        webmenu.setWebChromeClient(new WebChromeClient() {
