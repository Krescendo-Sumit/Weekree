...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uid = new MyDb(SearchActivity.this).getUserID().trim();;;
        ...
        webmenu.loadUrl(BaseUrl.HOSTNAME + "SerchProduct.php?uid="+uid+"&data=" + data+"&cataid=0");
        ...
        webmenu.setWebViewClient(new WebViewClient() {
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                String s1[] = s.split("-");
                //  Toast.makeText(SearchActivity.this, "" + s1[0], Toast.LENGTH_SHORT).show();
                if (s1[0].trim().equals("i")) {
                    Intent intent = new Intent(SearchActivity.this, SingleProductView.class);
                    intent.putExtra("id", s1[1]);
                    startActivity(intent);
                    //   Toast.makeText(SearchActivity.this, "Image Details", Toast.LENGTH_LONG).show();
                    ...
                    try {
                        pid = s1[1].toString().trim();
                        addtocartproduct(uid, pid);
                        Intent intent = new Intent(SearchActivity.this, ViewCart.class);
                        startActivity(intent);
                    } catch (Exception e) {
        ...
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, appURL, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    progress.dismiss();
                    Toast.makeText(SearchActivity.this, "Error : Loading Event Details" + error, Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
            ...
            MySingleton.getmInstance(SearchActivity.this).addToRequestque(stringRequest);

        } catch (Exception e) {
            progress.dismiss();
            Toast.makeText(SearchActivity.this, "Error is" + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void viewcart(View v) {
        try {
            if (ccnt < 1) {
                ...
                Toast.makeText(SearchActivity.this, "No Product in Cart", Toast.LENGTH_LONG).show();
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            Toast.makeText(SearchActivity.this, "" + ss[0], Toast.LENGTH_SHORT).show();
                            setbtntext("" + ss[1]);
